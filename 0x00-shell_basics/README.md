0- the first script prints the absolute path name of the current working directory
...
5- script thant Display current directory contents with Long format, with user and group IDs displayed numerically 